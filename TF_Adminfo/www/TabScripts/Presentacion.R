  ...
  tags$body(
    fluidRow(
      column(12,align="center",
             tags$h2("Análisis de Sentimientos en Comentarios de Facebook y Twitter"),
             tags$h3("Administración de la Información")
      ),
      column(6,align="center",
             tags$b("Video: Instalación de la Máquina Virtual"),
             tags$video(src="adminfo_script.mp4", type="video/mp4",controls=NA, autoplay=NA,
                        width=400)
      ),
      column(6,
             tags$b("Descripción del proyecto"),
             tags$p("Este proyecto consiste en el análisis de sentimientos de los comentarios
    ...
    fluidRow(
      column(12,align="center",
             tags$h3("Especificacion de(los) Datasets")
             ),
      column(6,
             tags$h5("Twitter", align="center"),
             tags$table(width="100%",
                        tags$tr(
                          tags$th("Atributo"),
                          tags$th("Tipo Variable"), #continuo o discreta
                          tags$th("Especificación")
                        ),
                        tags$tr(
                          tags$td("Date"),
                          tags$td("DateTime"),
